...
(function($) {
  ...
  $window.on("load", function() {
    ...
    $("#Preloader")
      .delay(350)
      .fadeOut(); // will fade out the white DIV that covers the website.
    $("body")
      .delay(350)
  ...
  // GitHubActivity.feed({ username: "adan206", selector: "ghfeed" });
  /*--------------------------------------------------------------
  ...
  $testimonial_slider.slick({
    ...
    adaptiveHeight: true,
    prevArrow:
      '<div class="slick-prev slick-nav-btn"><i class="fa fa-angle-left fa-2x"></i></div>',
    nextArrow:
      '<div class="slick-next slick-nav-btn"><i class="fa fa-angle-right fa-2x"></i></div>',
